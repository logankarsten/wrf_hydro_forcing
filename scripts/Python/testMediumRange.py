...
def main():
    ...
    GFS_files_with_path = [x for x in all_GFS_files_with_path if is_within_time_range(start_dt,end_dt,x,"GFS",is_yellowstone)]

    # do the processing on only the input grib files 
    do_regrid(GFS_dir_base,'GFS', GFS_files_with_path, is_yellowstone)
