...
def downscale_data(product_name, parser):
    """
    Performs downscaling of HRRR and NAM data.  
    NOTE: MRMS data DOES NOT need to be downscaled.      


    Args:
        product_name (string):  The product name: HRRR or NAM. MRMS data does 
                           not need to be downscaled.
...
if __name__ == "__main__":
    ...
    # From the config/parm file, retrieve the Logging level
    # Set the logging to the appropriate level, DEBUG for more verbose, 
    # or CRITICAL for the least verbose.  If no logging level is set, then
    # set logging to a minimum of CRITICAL.  
    ...
    if logging_level == 'DEBUG':
        ...
        #if logging_level == CRITICAL / default case
